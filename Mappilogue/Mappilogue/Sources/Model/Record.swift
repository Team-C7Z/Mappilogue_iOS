...
func dummyRecordData() -> [Record] {
    ...
    let record4 = Record(title: "코엑스 구경", image: "recordTest2", color: .colorE6C3F2, date: "3월 11일", location: "코엑스", category: "전시회", lat: 37.51266138067201, lng: 127.05882784390123)
    ...
    let record6 = Record(title: "여의도 공원", image: "recordTest3", color: .colorB2EBE7, date: "9월 12일", location: "여의도 공원", category: "전시회", lat: 37.5250892160129, lng: 126.947545050571)
    ...
    let record8 = Record(title: "남산 서울 타워", image: "recordTest3", color: .colorC9C6C2, date: "1월 17일", location: "남산 서울 타워", category: "휴가", lat: 37.55127433407266, lng: 126.98820799353979)
    let record9 = Record(title: "서울숲", image: "recordTest3", color: .colorF5DC82, date: "2월 23일", location: "서울숲", category: "휴가", lat: 37.5443222301513, lng: 127.037617759165)
